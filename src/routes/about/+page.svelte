...
<svelte:head>
  ...
  <meta name="description" content="Découvrez mes compétences en développement web et mon parcours" />
</svelte:head>
...
<div class="about-page">
  ...
  <section class="skills-section">
    ...
    <p class="section-intro">
      Voici un aperçu de mes compétences acquises et développées au fil de mes projets et expériences.
    </p>
              ...
              <div class="skill-item">
                ...
                <div class="skill-projects">
                  ...
                  {#each skill.projects as project, i}
                    <a href="/projects" class="project-link">{project}</a>{#if i < skill.projects.length - 1}, {/if}
                  {/each}
                </div>
              </div>
            {/each}
    ...
    <div class="timeline">
      ...
      <div class="timeline-item">
        ...
        <div class="timeline-content">
          ...
          <p>Développement de sites web et applications pour consolider mes compétences techniques.</p>
        </div>
      </div>
    </div>
  </section>
