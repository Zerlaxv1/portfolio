...
<div class="contact-page">
  <section class="contact-header">
    ...
    <p class="header-description">
      Vous avez un projet, une opportunité ou simplement une question ? N'hésitez pas à me contacter via ce formulaire.
    </p>
  </section>
  ...
  <div class="contact-content">
    <div class="contact-info">
      ...
      <div class="info-block">
        <h3>Disponibilité</h3>
        <p>Je suis actuellement disponible pour des opportunités professionnelles et des collaborations.</p>
      </div>
    </div>
